...
def lab_ini():
    ...
    address = "344011, Россия, Ростовская обл, Октябрьский р-н, г. Ростов-на-Дону, пр-кт Буденновский, д. 97, лит. А, Б, 2 этаж"
    ...
    lab1.add_measuring("86613", "Измеритель параметров микроклимата «Метеоскоп-М»", "Температура воздуха: ± 0,2°С; "
                                                                                    "Относительная влажность воздуха: ± 3 "
                                                                                    "%; Скорость движения воздуха: от 0,"
                                                                                    "1 до 1 м/с: ±(0.05+0.05V) м/с; от 1 "
